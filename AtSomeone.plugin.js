                ...
                children: children
                  .map((m) => {
                    ...
                    const splittedText = m?.text?.split(
                      new RegExp(LibraryUtils.regEscape("@someone"))
                    );
                    ...
                    const randomIndexValue = LibraryUtils.randomNo(0, guildMemberIds.length - 1);
                    const randomMemberId = guildMemberIds[randomIndexValue];
                    return LibraryUtils.interleave(textElementArray, {
                      type: "userMention",
