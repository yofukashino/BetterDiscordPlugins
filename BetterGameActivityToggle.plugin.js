...
`The library plugin needed for ${config.info.name} is missing. Please click Download Now to install it.`, {
     ...
     : (([Plugin, Library]) => {
        ...
        const enabledIcon = (width, height) => React.createElement('svg', {
            viewBox: '0 0 24 24',
            width,
            height,
            style: {
        ...
        const disabledIcon = (width, height) => React.createElement('svg', {
            viewBox: '0 0 24 24',
            width,
            height,
            style: {
        ...
        return class BetterGameActivityToggle extends Plugin {
            ...
            async loadSetting() {
                ...
                this.userPanel = BdApi.loadData(config.info.name, "userPanel") ?? true;
                ...
                this.keybind = BdApi.loadData(config.info.name, "keybind") ?? ["ctrl", "shift", "g"];
            }
            patchStatusPicker() {
                ...
                Patcher.before(SideBar, 'default', (_, args) => {
                    ...
                    if (!children.find(c => c?.props?.id == 'game-activity')) {
                        children.splice(children.indexOf(invisibleStatus) + 1, 0, React.createElement(SideBar.MenuItem, {
                                ...
                                }, enabled ? disabledIcon('16', '16') : enabledIcon('16', '16'), React.createElement('div', {
            ...
            async patchPanelButton() {
                ...
                Patcher.after(Account.__proto__, "render", (_, __, {
                    ...
                    props.children[1].props.children.unshift(React.createElement(PanelButton, {
                            icon: () => enabled ? enabledIcon('20', '20') : disabledIcon('20', '20'),
            ...
            getSettingsPanel() {
                return Settings.SettingPanel.build(this.saveSettings.bind(this),
                    new Settings.SettingGroup("Toogle Options", {
                        collapsible: true,
                        shown: true
                    }).append(new Settings.Keybind("Toggle by keybind:", "Keybind to toggle Game Activity", this.keybind, (e) => {
					this.keybind = e;
                        }),
