    ...
    return !global.ZeresPluginLibrary
      ...
      : (([Plugin, Library]) => {
          ...
          return class MarkAllRead extends Plugin {
            ...
            initiate() {
              this.addMenu();
              Dispatcher.subscribe("MESSAGE_ACK", () => this.addMenu());
            ...
            getPingedGuilds() {
              ...
              for (const id of guildIds) {
                if (this.blacklistedServers[id]) continue;
                PingedChannels.push(
            ...
            async makeMenu() {
              ...
              return {
                ...
                action: async () => this.markRead(AllMentions),
                children,
              };
            }
              ...
              return ContextMenu.buildMenuChildren([
                {
                  ...
                  action: async () => this.markRead(PingedGuilds, "Guild"),
                },
                {
                ...
                new SettingGroup("Server Blacklist", {
                  ...
                  ...Guilds.map((guild) => {
                    new Switch(
                      guild.name,
                      guild.description,
                      this.blacklistedServers[guild.id] ?? false,
                      (e) => {
                ...
                new SettingGroup("DM Blacklist", {
                  ...
                  ...DMs.map((DM) => {
                    ...
                    return new Switch(
                      User.tag,
                      User.pronouns,
                      this.blacklistedDMs[DM.id] ?? false,
                      (e) => {
