 ...
 * @updateUrl https://tharki-god.github.io/BetterDiscordPlugins/MessageHider.plugin.js
 */
/*@cc_on
@if (@_jscript)
...
module.exports = ((_) => {
  const config = {
    info: {
      ...
      github_raw:
        "https://tharki-god.github.io/BetterDiscordPlugins/MessageHider.plugin.js",
    },
    changelog: [
      {
        title: "v0.0.1",
