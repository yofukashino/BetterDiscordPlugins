 ...
 * @updateUrl https://raw.githubusercontent.com/Tharki-God/BetterDiscordPlugins/master/PingPong.plugin.js
 */
/*@cc_on
	@if (@_jscript)
...
module.exports = ((_) => {
  ...
  return !global.ZeresPluginLibrary
    ...
    : (([Plugin, Library]) => {
        const { PluginUpdater, Logger, WebpackModules, Patcher } = Library;
