     ...
     : (([Plugin, Library]) => {
         ...
         return class ShowNames extends Plugin {
           constructor() {
             ...
             this.ChannelNav = new MutationObserver(() =>
             this.addChannelNavListener()
           );
             this.ChannelChange = new MutationObserver(() =>
               this.applyMemberListPatch()
             )
           ...
           onStop() {
             ...
             this.ChannelNav.disconnect();
             this.ChannelChange.disconnect();
           }
           getSettingsPanel() {
