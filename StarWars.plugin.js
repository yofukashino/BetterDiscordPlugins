 ...
 * @updateUrl https://tharki-god.github.io/BetterDiscordPlugins/StarWars.plugin.js
 */
/*@cc_on
@if (@_jscript)
...
module.exports = (() => {
  const config = {
    info: {
      ...
      github_raw:
        "https://tharki-god.github.io/BetterDiscordPlugins/StarWars.plugin.js",
    },
    changelog: [
      {
        title: "v0.0.1",
                ...
                if (!GIF)
                  return MessageActions.receiveMessage(
                    ...
                    LibraryUtils.FakeMessage(
                      channel.id,
                      "Failed to get any Star Wars GIF."
                    )
                  );
                send.value
